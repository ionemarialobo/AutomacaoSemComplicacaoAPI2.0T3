...
class ContaTest {
    ...
    //para criar o metodo beforeeach
    // sentença criada pelo BeforeEach Class metodo alt+insert ou botao direito GENERATION
    @BeforeEach
    void setUp() {
    ...
    //metodo realizar transação
    public void realizarTransacao() {
        contaXuxa.realizarTransferencia(1000.00, contaSilvioSantos);

        //assertequals é uma validação
        // Validação OK. Ou seja depois de transferir tem
        //que sair mil da conta da xuxa e tem que incrementar mil na conta do silvio
        assertEquals(1500.00, contaXuxa.getSaldo());
        assertEquals(4500.00, contaSilvioSantos.getSaldo());

        ////validação NOK. Ou seja depois de transferir tem
        //que sair mil da conta da xuxa e tem que incrementar mil na conta do silvio
        assertEquals(1500.00, contaXuxa.getSaldo());
        assertEquals(4500.00, contaSilvioSantos.getSaldo());
    }
